...
export default function Service() {
  return (
    <div className="bg-[#27272E] w-full px-[20px]">
      <div>
        <h3 className="text-[#c75c6f]">What We Can Do For You</h3>
        <h1 className="text-white">Services we can help you with</h1>
      ...
      <div>
        ...
        <div className=" style.oneBox  ">
          ...
          {/* text */}
          <div>
            <h1 className="text-xl lg:text-2xl text-white  transition delay-75 duration-300 ease-in  font-medium">
              Website Designing
            </h1>
            <p className="text-[#b5b7b8] ">
